...
export default function Intro() {
  return (
    ...
    >
      ...
      >
        <span className="font-bold uppercase">Bharat Khatri Chhetri</span>
      ...
      >
        <a
          ...
          href="https://www.linkedin.com/in/bharat-kc-876b70265/"
          target="_blank"
        >
          <BsLinkedin />
        </a>
        ...
        <a
          ...
          href="https://github.com/bikky-kc013"
          target="_blank"
        >
          <BsGithub />
        </a>
        ...
        <a
          className="p-4 flex items-center gap-2 rounded-full focus:scale-[1.10] hover:scale-[1.10] active:scale-105 transition cursor-pointer border bg-black text-white/80 border-white/10"
          href="mailto:bharathkc013@gmail.com"
          target="_blank"
        >
          <MdEmail />
        </a>
